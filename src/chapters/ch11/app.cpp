...
{
    // Load shader module.
    mComputeShader = createShaderModule(mDevice, fs::path("shaders/ch11/ch11.spv"));
...
void VulkanApp::run()
{
    ...
    stbi_write_hdr("../../scenes/ch11.hdr", mWindowExtents.width, mWindowExtents.height, 3, reinterpret_cast<float*>(data));
